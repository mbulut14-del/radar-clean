...
class ClickCard(ButtonBehavior, BoxLayout):
    ...
    def __init__(self, coin_data=None, **kwargs):
        super().__init__(**kwargs)
        self.coin_data = coin_data or {}

    def on_release(self):
        App.get_running_app().open_detail(self.coin_data)


class MainScreen(Screen):
    hero_coin = StringProperty("MMT_USDT")
    hero_score = StringProperty("42")
...
class KVTestApp(App):
    def build(self):
        ...
        Clock.schedule_once(self.populate_main, 0)
        return self.sm
    ...
    def populate_main(self, *args):
        ...
        main.hero_info = (
            ...
            f"[color=ffffff]Degisim:[/color] [color=00ff88]%38.57[/color]\\n"
